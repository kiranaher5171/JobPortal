                                ...
                                <Box pt={3} pb={3}>
                                    ...
                                    >
                                        <Box sx={{ textAlign: 'center' }}>
                                            <WorkOutlineOutlinedIcon sx={{ fontSize: 40, color: 'white', mb: 1 }} />
                                            <Typography variant="h4" className='white fw6' sx={{ mb: 0.5 }}>
                                                10,000+
                                            </Typography>
                                            <Typography variant="body2" className='white' sx={{ opacity: 0.9 }}>
                                                Active Jobs
                                            </Typography>
                                        </Box>
                                        <Box sx={{ textAlign: 'center' }}>
                                            <TrendingUpOutlinedIcon sx={{ fontSize: 40, color: 'white', mb: 1 }} />
                                            <Typography variant="h4" className='white fw6' sx={{ mb: 0.5 }}>
                                                5,000+
                                            </Typography>
                                            <Typography variant="body2" className='white' sx={{ opacity: 0.9 }}>
                                        ...
                                        <Box sx={{ textAlign: 'center' }}>
                                            <LocationOnOutlinedIcon sx={{ fontSize: 40, color: 'white', mb: 1 }} />
                                            <Typography variant="h4" className='white fw6' sx={{ mb: 0.5 }}>
                                                50+
                                            </Typography>
                                            <Typography variant="body2" className='white' sx={{ opacity: 0.9 }}>
