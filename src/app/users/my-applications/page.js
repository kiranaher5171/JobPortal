...
export default function MyApplicationsPage() {
  ...
  const fetchApplications = async () => {
    try {
      ...
      const response = await fetch("/api/users/my-applications", {
            ...
            <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 4, flexWrap: "wrap", gap: 2 }}>
              <Box>
                ...
                <Typography variant="body1" className="text-secondary">
                  Track the status of your job applications and referrals ({applications.length})
                </Typography>
              </Box>
            ...
            {loading ? (
              ...
              <Box className="whitebox" sx={{ p: 4, textAlign: "center" }}>
                ...
                <Typography variant="body1" className="text-secondary" sx={{ mb: 3 }}>
                  You haven't submitted any applications or referrals yet.
                </Typography>
                      ...
                      <TableRow key={application._id} hover>
                        ...
                        <TableCell>
                          {application.type === "referral" ? (
                            ...
                            <Typography variant="body2" className="fw6">
                              {application.candidateName || user.name || "You"}
                            </Typography>
                          )}
                        </TableCell>
                        <TableCell>
      ...
      >
        {selectedApplication && (
          <>
                ...
                <Box>
                  ...
                  <Box sx={{ pl: 2, display: "flex", flexDirection: "column", gap: 1 }}>
                    ...
                    {selectedApplication.candidatePhone && (
                      <Typography variant="body2" className="text-secondary">
                        <strong>Phone:</strong> {selectedApplication.candidatePhone}
                      </Typography>
                    )}
                  </Box>
                </Box>
            ...
            <DialogActions>
              <Button className="secondary-action-btn" onClick={handleCloseDetailDialog}>Close</Button>
            </DialogActions>
          </>
        )}
      </Dialog>
